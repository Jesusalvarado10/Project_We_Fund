        ...
        <div className="bg-white rounded-2xl shadow-2xl flex w-2/33 max-w-4xl ">
            <div className="w-50/5 p-5">
                <div className="text-left">
                    ...
                    <h1>Empoderar a las personas para que transformen el mundo a través de la acción colectiva y la generosidad.
                    ...
                    <h3>Juntos, en WeFund, podemos marcar la diferencia.</h3>
